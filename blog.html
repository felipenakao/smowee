...
<body id="page-top" class="index">
    ...
    <section id="blog">
      <div class="container">
          <div class="row">
              <div class="col-lg-12">
                <span style="display: flex;justify-content: center;align-items: center ;width:750px;height:90px;position:absolute;background-color:yellowgreen;right:25px;text-align:center;">
                ANÚNCIO
              </span>
...
Próxima página >>
      ...
      <div class="sidebar">
        ...
        <ul>
          <h4>Categorias</h4>
          <li id="news-cat-sidebar-1">
            Saúde
          </li>
          <li id="news-cat-sidebar-2">
            Cotidiano
          </li>
          <li id="news-cat-sidebar-3">
            Tecnologia
          </li>
          <li id="news-cat-sidebar-4">
            Economia
          </li>
        </ul>

        <ul>
          <li style="width:100%; height:150px;background-color:yellowgreen;">
          ANÚNCIO
          </li>
        </ul>
        ...
        <ul>
          <li style="width:100%; height:300px;background-color:yellowgreen;">
          ANÚNCIO
          </li>
        </ul>
